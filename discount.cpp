                        ...
                        do
                        {
                                ...
                                do
                                {
                                    ...
                                    else if (choice == '1') // viewing stock
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            cout << endl
                                                 << endl
                                                 << "Please enter (y) to continue using program: ";
                                            cin >> continueChoice;
                                            cin.ignore();
                                        ...
                                        for (int i = 0; i < newItems; i++)
                                        {
                                            ...
                                            do
                                            {
                                                ...
                                                for (int k = 0; k < count; k++)
                                                {
                                                    ...
                                                    {
                                                        cout << endl
                                                             << " This item code already exists! Please enter another one" << endl;
                                                        found = 1;
                                                    }
                                                }
                                                ...
                                                for (int k = 0; k < i; k++)
                                                {
                                                    ...
                                                    {
                                                        cout << endl
                                                             << " You have already entered this item code before! Please enter another one" << endl;
                                                        found = 1;
                                                    }
                                                }
                                            ...
                                            do
                                            {
                                                ...
                                                for (int k = 0; k < count; k++)
                                                {
                                                    ...
                                                    {
                                                        cout << endl
                                                             << " This item name already exists! Please enter another one" << endl;
                                                        found = 1;
                                                    }
                                                }
                                                ...
                                                for (int k = 0; k < i; k++)
                                                {
                                                    ...
                                                    {
                                                        cout << endl
                                                             << " You have already entered this item name before! Please enter another one" << endl;
                                                        found = 1;
                                                    }
                                                }
                                    ...
                                    {
                                        cout << endl
                                             << setw(117) << "-----EDITING QUANTITY-----" << endl
                                             << endl;
                                        char again = 'y';
                                        ...
                                        do
                                        {
                                            ...
                                            if (found == 1)
                                            {
                                                ...
                                                else if (choiceEdit == '-')
                                                {
                                                    ...
                                                    {
                                                        cout << endl
                                                             << " Not enough stock to decrease from! Do you wish to try again? (y/n): ";
                                                        cin >> again;
                                                        cin.ignore();
                                            ...
                                            {
                                                cout << endl
                                                     << " Item not found! Do you wish to try again with correct item code? (y/n): ";
                                                cin >> again;
                                                cin.ignore();
                                ...
                                do
                                {
                                    ...
                                    else if (discountChoices == '1') // discounts on items
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                cout << endl
                                                     << setw(115) << "-----ADDING DISCOUNTS-----" << endl
                                                     << endl;
                                                ...
                                                if (!fout.fail())
                                                {
                                                    ...
                                                    do
                                                    {
                                                        ...
                                                        cout << endl
                                                             << " Please enter Item code of the item you wish to add disscount on: ";
                                                        cin >> itemcodeDIS;
                                                        cin.ignore();
                                                        ...
                                                        {
                                                            cout << endl
                                                                 << "This Item already has a discount of " << discountItemprecentage[DisINDEX] << "% Please delete this Item and try again to change it's discount " << endl
                                                                 << endl;
                                                    ...
                                                    cout << endl
                                                         << endl
                                                         << " All the Discounts and edits have been saved successfully" << endl
                                                         << endl;
                                                }
                                                else
                                                {
                                            ...
                                            {
                                                cout << endl
                                                     << setw(115) << "-----DELETING DISCOUNTS-----" << endl
                                                     << endl;
                                                ...
                                                do
                                                {
                                                    ...
                                                    cout << endl
                                                         << " Please enter Item code of the item you wish to delete disscount of: ";
                                                    cin >> itemcodeDEL;
                                    ...
                                    else if (discountChoices == '2') // discount on bill
                                    {
                                        ...
                                        cout << endl
                                             << setw(115) << "-----DISCOUNT ON BILL-----" << endl
                                             << endl;

                                        cout << " Current Percentage of discount is " << discountOnWholeBill() << endl
                                             << endl;
                                        ...
                                        {
                                            cout << endl
                                                 << " Please enter percentage of discount on whole bill: ";
                            ...
                            else if (choice2 == '2') // customer record management
                            {
                                ...
                                do
                                {
                                    ...
                                    cout << endl
                                         << " Please enter Bill Number of the record you wish to view: ";
                                    cin >> billNumber;
                                    ...
                                    while (cin.fail())
                                    {
                                        ...
                                        cout << endl
                                             << " Please again enter Bill Number of the record you wish to view: ";
                                        cin >> billNumber;
                                    }
                                    ...
                                    if (found == 1)
                                    {
                                        ...
                                        cout << " Amount of bill     : " << customerTotal[foundBill] << endl
                                             << endl;
                                    ...
                                    {
                                        cout << endl
                                             << " Record with this bill number not found! Please try again with correct bill number." << endl;
                                        cout << endl
                            ...
                            else if (choice2 == '3') // adding new admin
                            {
                                ...
                                if (adminCheck == 0)
                                {
                                    ...
                                    if (!fout.fail())
                                    {
                                        ...
                                        cout << endl
                                             << endl
                                             << " New admin added successfully!" << endl;
                                    }
                                    else
                                    {
                                        cout << endl;
                                ...
                                do
                                {
                                    ...
                                    else if (choice4 == '2') // changing pin
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                cout << endl
                                                     << " The Pin you entered is already saved as your current Pin. Please enter a different Pin" << endl
                                                     << endl;
                                                cout << "Do you wish to try again(y/n): ";
                                                cin >> newUserTryAgain;
                                                cin.ignore();
                ...
                do
                {
                    ...
                    else if (choice5 == '2') // generating bill
                    {
                        ...
                        do
                        {
                            ...
                            cout << endl
                                 << " Do you wish to view whole stock for checking items (y/n): ";
                            cin >> viewStockItem;
                            cin.ignore();
                            ...
                            do
                            {
                                ...
                                else
                                {
                                    cout << endl
                                         << endl
                                         << " Invalid\aInput The item code does not exist " << endl;
                                    cout << endl
                                         << " Do you wish to try again? (y/n): ";
                                    cin >> again;
                                    cin.ignore();
                            ...
                            if (!fout.fail())
                            {
                                ...
                                cout << endl
                                     << " Receipt is generated successfully! Please check receipt.txt file." << endl;
                            }
                            else
                            {
                                cout << endl
                            ...
                            if (donecheck == 0)
                            {
                                ...
                                {
                                    cout << endl
                                         << " Error!\a Could not open stock.txt file for updating stock after generating bill" << endl;
                                }
                            }

                            cout << endl
                                 << "Stock is updated successfully after generating bill!" << endl;
                    ...
                    else if (choice5 == '3') // view discounts
                    {
                        char continueDiscount = 'y';

                        do
                        {
                            char discountViewChoice;
                            ...
                            cout << " 3. Back" << endl;
                            cout << " Enter your choice: ";
                            cin >> discountViewChoice;
                            cin.ignore();

                            while (discountViewChoice != '1' && discountViewChoice != '2' && discountViewChoice != '3')
                            {
                                cout << "-----INVALID INPUT!----- "
                                     << endl
                                     << endl;
                            ...
                            if (discountViewChoice == '3')
                            {
                                break;
                            }

                            if (discountViewChoice == '1')
                            {
                                ...
                                cin >> continueDiscount;
                                cin.ignore();
                            }

                            else if (discountViewChoice == '2')
                            {
                                char itemChoice;
                        ...
                        } while (continueDiscount == 'y' || continueDiscount == 'Y');
                    }
