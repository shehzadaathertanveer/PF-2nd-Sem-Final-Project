                            ...
                            else if (choice2 == 2) // customer record management
                            {
                                ...
                                do
                                {
                                    ...
                                    if (found == 1)
                                    {
                                        ...
                                        cout << " Total amount of bill    : " << customerTotal[foundBill] << endl
                                             << endl;
                ...
                do
                {
                    ...
                    else if (choice2 == 2) // generating bill
                    {
                        ...
                        do
                        {
                            ...
                            int wholeBillDiscount = 0;

                            cout << endl;
                            cout << " Do you wish to give discount?" << endl;
                            cout << " 1. Yes" << endl;
                            cout << " 2. No" << endl;
                            cout << " Enter choice: ";
                            cin >> discountChoice;
                                ...
                                if (boughtItemNumber != -1)
                                {
                                    ...
                                    if (boughtItemQuantity <= itemQuantity[boughtItemNumber])
                                    {
                                        ...
                                        itemTotal = boughtItemPrice * boughtItemQuantity;
                                            if(discountChoice == 1 && discountType == 2)
                                            {
                                                int itemDiscountChoice = 0;
                                                int itemDiscountPercent = 0;
                                                cout<<endl;
                                                cout<<" Do you want discount on this item: "<<endl;
                                                cout<<" 0. No"<<endl;
                                                cout<<" 1. Yes"<<endl;
                                                cout<<" Enter choice: ";
                                                cin>>itemDiscountChoice;
                                                cin.ignore();
                                                if(itemDiscountChoice == 1)
                                                {
                                                    cout<<"Enter discount percentage: ";
                                                    cin>>itemDiscountPercent;
                                                    cin.ignore();
                                                    itemDiscountArray[boughtItemCount] = itemDiscountPercent;
                                                    itemTotal = itemTotal - (itemTotal * itemDiscountPercent/100);
                                                }
                                            }
                            ...
                            cout << endl
                                 ...
                                 if(discountChoice == 1 && discountType == 1)
                                        {
                                            cout << endl << " Enter wohle bill discount percentage: ";
                                            cin >> wholeBillDiscount;
                                            cin.ignore();

                                            grandTotal = grandTotal - (grandTotal * wholeBillDiscount / 100.0);
                                        }
